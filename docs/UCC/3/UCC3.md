...
Apart from these, other definitions applying to this Article and the sections in which they appear like "Acceptance," "Issue," "Instrument," "Value," etc., are listed under subsection (b). 
...
(i) "Traveler's
		check" means an instrument that (i) is
...
Subsection (a) explains that a promise or order is considered unconditional unless it explicitly states a condition to payment, is subject to another record, or the rights or obligations are mentioned in another record. Simply referencing another record does not make the promise or order conditional.
...
This is an important regulation because it ensures flexibility and fairness in transactions involving foreign currencies. It protects parties involved in such transactions from potential losses due to fluctuating exchange rates. 
...
(a) An obligation is considered "payable on demand" if it explicitly states so, or if it doesn't mention a specific time of payment. Essentially, the holder can ask for payment at any time.
...
(ii) a person described as agent or similar representative
	of a named or identified person, the instrument is
...
(d) An action to enforce the
	...
	check must be commenced within three years after demand for payment is made
...
f) If you're trying to enforce payment from someone who owes you money on an accepted draft (not a certified check), you have six years from the due date or the date of acceptance (depending on whether the obligation is payable at a specific time or on demand).
...
(d) If a transferor tries to transfer less than the entire instrument, the negotiation of the instrument does not happen. The transferee does not get any rights under this Article and only has the rights of a partial assignee.
...
This section pertains to restrictive endorsements on negotiable instruments (e.g., checks, promissory notes). 
...
This means that even if you are not the original owner of a contract or legal document but have it in your possession, you may still have the legal right to enforce the terms of that document. Similarly, even if you do not physically possess the document but are entitled to enforce it under specific laws, you can still be considered a person entitled to enforce it. Interestingly, the law also allows for a person to be considered entitled to enforce an instrument even if they are in wrongful possession of it, implying that the legality of possession is secondary to the right to enforce the instrument's terms.
...
Subsection (b) adds that a holder in due course can also enforce the obligation, subject to the defenses stated in subsection (a)(1), but not those in subsection (a)(2) or (a)(3). 
...
However, if someone is a holder in due course – meaning they took the instrument in good faith, without knowledge of any problems, and for value – they are not subject to these claims. This means they can keep the instrument even if the original owner claims it was lost, stolen, or forged.
...
This section is sandwiched between § 3-308 which discusses proof of signatures and holder status, and § 3-310 which deals with the effect of an instrument on the obligation for which it was taken.
...
(c) If the obligated
		...
		the check is presented for payment by a person having rights of a holder
...
(c) If a representative signs
	the name of the representative as drawer of a check without
...
(c) Under subsection (a) or
	...
	the instrument, whether or not indorsed, is deposited
...
(b) For the purpose of determining
	...
	pays an instrument or takes it for value or for collection,
	...
	makes a fraudulent indorsement of the instrument,
	the indorsement is effective as the indorsement of
	...
	for collection fails to exercise ordinary care in
...
(c) Under subsection (b),
	an indorsement is made in the name of the person
	to whom an instrument is payable if (i) it is made
...
### commentary on ## § 3-405. EMPLOYER’S	RESPONSIBILITY FOR FRAUDULENT INDORSEMENT BY EMPLOYEE.


This section deals with the responsibility of an employer in cases where an employee has fraudulently endorsed an instrument. 

In layman's term, it means the following. Imagine running a small business and one of your employees is involved in a fraudulent activity. They forge your signature on a check. This is a fraudulent endorsement. Now, how responsible are you, as the employer, for this fraudulent act by your employee?

According to this section, if you had entrusted the employee with the responsibility related to the handling of such instruments, then in the eyes of the law, the endorsement is considered valid. So, if someone accepts the check in good faith and suffers a loss because of the fraud, they can hold you responsible for the loss. 

However, the person accepting the check also has a duty of care. If they didn't exercise ordinary care (for example, they didn't verify the signature properly) and this contributed to their loss, then their ability to recover the loss from you may be reduced.

The section also clarifies a few definitions. For example, an employee can include an independent contractor, and 'responsibility' does not merely mean access to the instruments.

[No significant timeline events or commonly-referred counterparts provided in the statute.]
...
(a) A person whose failure
	to exercise ordinary care substantially contributes
	to an alteration of an instrument or
	to the making of a forged signature on an instrument is precluded from asserting
	the alteration or the forgery against a person who, in good
	faith, pays the instrument or takes it for value or for collection.
(b) Under subsection (a),
	if the person asserting the preclusion fails to exercise ordinary
	care in paying or taking the instrument and that
...
(c) Under subsection (a),
	the burden of proving failure to exercise ordinary care is
...
### commentary on ## § 3-406. NEGLIGENCE	CONTRIBUTING TO FORGED SIGNATURE OR ALTERATION OF INSTRUMENT.


This section of the law is about negligence that has substantially contributed to forged signatures or alterations on a legal financial instrument (like a check or a promissory note). 

In a nutshell, this law says that if someone didn't take the proper care and this failure significantly contributed to the forgery or alteration of the instrument, they cannot blame or sue another party who, in good faith, paid the instrument or took it for value or collection. 

But there's a caveat. If the person who is claiming this legal protection (preclusion) also didn't take proper care and this negligence caused some loss, then the loss will be shared between both parties. The allocation of the loss would be based on how much each party's lack of care contributed to the loss. 

The burden of proof falls on the person asserting the preclusion to prove that the other party didn't exercise ordinary care. If losses have to be allocated, the person who is being precluded from making a claim will have to prove that the person asserting the preclusion also didn't take proper care.

So this law is a sort of a safeguard for people who unknowingly deal with a forged or altered instrument, but it also expects all parties to exercise proper care to prevent such instances.
...
### commentary on ## § 3-407. ALTERATION.


This clause defines what constitutes an "alteration" of an instrument such as a check or promissory note. It categorizes alteration as either an unauthorized change that modifies a party's obligation or an unauthorized addition or change to an incomplete instrument related to a party's obligation.

The clause also outlines the consequences of an alteration. If an alteration is made fraudulently, it discharges the party whose obligation is changed by the alteration unless they agreed to the change or cannot assert the alteration for some reason. The only exception to this rule is for a payor bank or drawee who pays an altered instrument or a person who takes it for value, in good faith, without knowledge of the alteration. They may enforce rights according to the original terms of the instrument or, in the case of an incomplete instrument altered by unauthorized completion, according to its completed terms.

In simple terms, if someone changes the information on a check without permission and tries to cash it, the party who originally wrote the check isn't responsible for the altered amount unless they knowingly agreed to the change or for some reason can't challenge the alteration. However, if a bank unknowingly cashes an altered check, they have the right to enforce the original terms of the check or, if it was incomplete when altered, the terms as completed.
...
A check or other draft does
	not of itself operate as an assignment of funds in the hands of the drawee available
	for its payment, and the drawee is not liable on the instrument until
...
### commentary on ## § 3-408. DRAWEE	NOT LIABLE ON UNACCEPTED DRAFT.


This section clarifies the liability of the drawee (the entity who is expected to pay the check or draft) in the case of an unaccepted check or draft. According to this, a check or a draft doesn't automatically assign funds in the drawee's possession for its payment. Also, the drawee isn't liable for the instrument unless they accept it.

Analogy: Think of the drawee as a hotel guest who has been presented with a bill. The mere presentation of the bill does not mean that the guest's money (funds) is automatically allotted to pay that bill. Also, the guest isn't liable to pay the bill unless they accept it.

Commonly referred counterparts: This rule is a commonly referred counterpart in situations involving bounced checks or drafts, where the drawee's acceptance hasn't been secured. 

Significant timeline events: This section becomes significantly applicable when the drawee's acceptance is in question, raising issues of liability and fund allocation.
...
(a) "Acceptance" means
	the drawee's signed agreement to pay a draft as
...
(d) "Certified
		check" means a check accepted by the bank
		on which it is drawn. Acceptance may be made as stated in subsection
		(a) or by a writing on the check which indicates that the check is certified. The drawee of
...
### commentary on ## § 3-409. ACCEPTANCE	OF DRAFT; CERTIFIED CHECK.


In layman's terms, this section discusses the concept of "acceptance" in the context of drafts and certified checks. 

(a) "Acceptance" is when a drawee (the person or entity that the check is drawn on) agrees to pay a draft (order to pay a specific sum). This agreement to pay must be written on the draft, which can be just the signature of the drawee. This acceptance can be made at any point and becomes valid when the drawee notifies the person who initiated the draft or when the accepted draft is given to someone for the purpose of establishing rights on the acceptance.

(b) A draft can still be accepted even if it lacks the signature of the drawer (the person who writes the check), is incomplete, overdue, or has been dishonoured.

(c) If a draft is set to be payable at a specific time period after it has been seen and the acceptor forgets to date the acceptance, the holder of the draft can complete the acceptance by providing a date in good faith.

(d) A "certified check" is a check that has been accepted by the bank it is drawn on. The acceptance can be done in the way stated in subsection (a) or by a written indication on the check that it is certified. The drawee of a check is not obliged to certify the check, and refusal to certify is not considered as dishonoring the check.

In sum, this section clarifies how acceptance works in the context of drafts and checks, and also explains what a certified check means. It provides important guidelines for the parties involved in a transaction using drafts or checks.
...
(a) If the terms of a drawee's acceptance vary
	from the terms of the draft as presented, the holder may
	refuse the acceptance and treat the draft as dishonored. In that case,
	the drawee may cancel the acceptance.
(b) The terms of a draft are
	not varied by an acceptance to pay at a particular
...
(c) If the holder assents
	to an acceptance varying the terms of a draft,
	the obligation of each drawer and indorser that
...
### commentary on ## § 3-410. ACCEPTANCE	VARYING DRAFT.


This section outlines the procedures and rights concerning a drawee's acceptance of a draft that does not match the original terms. 

Subsection (a) makes it clear that if a drawee's acceptance significantly varies from the original draft, the holder of the draft can refuse the acceptance and treat it as dishonored. It also gives the drawee the right to cancel the acceptance.

Subsection (b) explains that the terms of a draft aren't considered varied if the acceptance commits to payment at a specific bank or location within the US, unless the acceptance specifically states that the draft can only be paid at that location.

Subsection (c) stipulates that if the holder of a draft accepts an amendment to the draft's terms, any drawer or indorser who hasn't explicitly agreed to the acceptance is released from their obligations.

In simpler terms, this section is essentially saying that if a draft is accepted with changes, the holder has the right to reject this acceptance and still consider the draft as unpaid. The only exception is when the acceptance simply specifies a specific payment location, unless it adds that this is the only accepted payment location. Finally, if the holder agrees to the revised acceptance, those who didn't specifically agree to the changes are no longer bound by the draft.
...
### commentary on ## § 3-411. REFUSAL	TO PAY CASHIER'S CHECKS, TELLER'S CHECKS, AND CERTIFIED CHECKS.


This section discusses the legal responsibilities of the "obligated bank," which is defined as the bank that has accepted a certified check or issued a cashier's or teller's check. It states that if the bank wrongfully refuses to pay these checks or stops payment on a teller's check, the person who holds the check has a right to compensation for any expenses or lost interest caused by the non-payment. The holder of the check may also be entitled to additional damages if the bank still refuses to pay after being notified of specific circumstances that have led to these damages.

However, the holder of the check cannot recover any expenses or damages if the bank's refusal to pay is due to one of several listed reasons. These include a suspension of bank payments, a claim or defense that the bank reasonably believes it has against the holder of the check, reasonable doubt about the identity of the person demanding payment, or a legal prohibition against payment. 

This section thus serves to balance the rights and interests of both the person holding the check and the obligated bank. It discourages wrongful refusal of payment by banks while also acknowledging situations under which banks might be justified in refusing payment.
...
The issuer of a note or cashier's
		check or other draft drawn on the drawer is
		obliged to pay the instrument (i) according to its
		terms at the time it was issued or, if not issued, at
		the time it first came into possession of a holder, or (ii) if the issuer signed
		an incomplete instrument, according to
		its terms when completed, to the extent stated in Sections 3-115 and 3-407. The
		obligation is owed to a person entitled
		to enforce the instrument or to an indorser who
...
### commentary on ## § 3-412. OBLIGATION	OF ISSUER OF NOTE OR CASHIER’S CHECK.


The section essentially states that the issuer of a note or cashier’s check is legally obligated to pay according to the terms specified at the time of the instrument's issuance, or if it was not issued, when it first came into the possession of a holder. If the instrument was incomplete when signed by the issuer, the obligation to pay still stands, but according to the terms when it was completed. 

This obligation is owed to the person who has the right to enforce the instrument (typically the holder or depositor), or an indorser (someone who has endorsed or signed the instrument, usually on the back) who has already paid the instrument under Section 3-415. 

Analogously, it's like buying a prepaid gift card from a store. The store, as the issuer of the card or 'instrument', is obligated to honor the value of the card when presented for payment by the holder of the card, as specified at the time of the card's purchase or activation. 

A significant timeline event for this section would be when the instrument is first issued or comes into possession of a holder. This is the point at which the issuer’s obligation to pay according to its terms is established. 

A commonly referred counterpart to the issuer in this context could be a bank or financial institution, as they frequently issue notes or cashier’s checks. The counterpart to the person entitled to enforce the instrument would be the holder of the note or check, while the counterpart to the indorser would be an individual or entity who has endorsed the check for payment.
...
(a) The acceptor of
	a draft is obliged to pay the draft (i) according to its
	terms at the time it was accepted, even though the acceptance states
	...
	of the draft as varied, or (iii) if the acceptance is of a draft that
	is an incomplete instrument, according to
	its terms when completed, to the extent stated in Sections 3-115 and 3-407. The
	obligation is owed to a person entitled to
	enforce the draft or to the drawer or an indorser
	who paid the draft under Section 3-414 or 3-415.
(b) If the certification of
	a check or other acceptance of
	a draft states the amount certified or accepted, the obligation
	of the acceptor is that amount. If (i) the certification
	or acceptance does not state an amount, (ii) the amount of the instrument is
	subsequently raised, and (iii) the instrument is then negotiated to a holder
	in due course, the obligation of the acceptor is
...
### commentary on ## § 3-413. OBLIGATION	OF ACCEPTOR.


The acceptor of a draft (a written order by one party to another to pay a certain sum) is obliged to pay according to the terms of the draft at the time of acceptance, even if the acceptance specifies that the draft is payable "as originally drawn" or similar wording. If the acceptance alters the terms of the draft, the acceptor is obliged to pay according to the adjusted terms. If the draft was incomplete when accepted, the acceptor must pay according to the terms once it's completed. This obligation is owed to the person who can enforce the draft or the drawer or indorser who paid the draft. 

Furthermore, if the draft states the amount certified or accepted, the acceptor is obliged to pay that amount. If the draft doesn't state an amount and the instrument's amount is raised later, then the acceptor is obliged to pay the amount of the instrument at the time it was taken by the holder in due course.

In simpler terms, this section deals with the obligations of the person accepting a draft or check. It states that they are responsible for paying the amount specified at the time of their acceptance, even if the terms change later. They are also responsible for the payment to the rightful owner of the draft, whether that's the original issuer or a third party who has since obtained the draft. And, if the draft doesn't specify an amount, the acceptor is still responsible for paying the amount that is ultimately decided or negotiated.
...
(a) This section does not
	apply to cashier's checks or other drafts drawn
	on the drawer.
(b) If an unaccepted draft is
	dishonored, the drawer is obliged to pay the draft (i)
	according to its terms at the time it was issued or, if
	not issued, at the time it first came into possession of a holder, or (ii) if
	the drawer signed an incomplete instrument,
	according to its terms when completed, to the extent stated in Sections 3-115 and 3-407. The
	obligation is owed to a person entitled to
	enforce the draft or to an indorser who paid the
	draft under Section 3-415.
(c) If a draft is
	accepted by a bank, the drawer is discharged, regardless
	of when or by whom acceptance was obtained.
(d) If a draft is
	accepted and the acceptor is not a bank, the obligation
	of the drawer to pay the draft if the draft is dishonored
...
(e) If a draft states
	...
	of the drawer to pay the draft, the drawer is not liable
...
(f) If (i) a check is
	...
	30 days after its date, (ii) the drawee suspends payments
	...
	by assigning to the person entitled to enforce the
...
### commentary on ## § 3-414. OBLIGATION	OF DRAWER.


This section provides details on the obligations of the drawer of a draft (a type of negotiable instrument, such as a check). 

Subsection (a) clarifies that this section does not apply to cashier's checks or drafts drawn on the drawer. 

Subsection (b) states that if an unaccepted draft is dishonored, the drawer is required to pay according to the terms at the time it was issued or when it first came into possession of a holder. If the drawer signed an incomplete instrument, they must pay according to its terms when completed.

Subsection (c) indicates that if a draft is accepted by a bank, the drawer is discharged from any obligation.

Subsection (d) states that if a draft is accepted by a non-bank entity, the drawer’s obligation to pay if the draft is dishonored is equivalent to the obligation of an indorser. 

Subsection (e) explains that if a draft states it is drawn “without recourse” or disclaims liability of the drawer, the drawer is not liable to pay the draft unless it is a check.

Subsection (f) outlines conditions under which a drawer may discharge its obligation to pay a check: if the check is not presented for payment or given to a bank for collection within 30 days, the drawee suspends payments without paying the check, and deprivation of funds is due to suspension of payments. 

In simpler terms, this section lays out the responsibilities of the person (drawer) who writes a check or draft, and the scenarios in which they can be freed of obligation to pay.
...
(a) Subject to subsections
	(b), (c), and (d) and to Section 3-419(d), if an instrument is
	dishonored, an indorser is obliged to pay the amount
	due on the instrument (i) according to the terms of the instrument at the time
	it was indorsed, or (ii) if the indorser indorsed an incomplete
	instrument, according to its terms when completed, to the extent stated
	in Sections 3-115 and 3-407. The
	obligation of the indorser is owed to a person
...
(b) If an indorsement states
	...
	of the indorser, the indorser is not liable under subsection (a) to pay the instrument.
(c) If notice of dishonor
	of an instrument is required by Section 3-503 and
	notice of dishonor complying with that section is not given to an indorser,
	the liability of the indorser under subsection (a) is discharged.
(d) If a draft is
	accepted by a bank after an indorsement is made,
	the liability of the indorser under subsection (a) is
	discharged.
(e) If an indorser of
	a check is liable under subsection (a) and the check is
	not presented for payment, or given to a depositary bank for collection, within
	30 days after the day the indorsement was made, the
...
### commentary on ## § 3-415. OBLIGATION	OF INDORSER.


This section outlines the obligations of the Indorser under various circumstances:

(a) Unless otherwise stated, if an instrument (like a check or promissory note) is dishonored, the Indorser is liable to pay the amount due according to the terms of the instrument at the time of indorsement, or as per its terms when completed, in case it was incomplete at the time of indorsement. The Indorser owes this obligation to the person entitled to enforce the instrument or to a subsequent Indorser who paid the instrument under this section.

(b) If the Indorser's endorsement explicitly states "without recourse" or otherwise disclaims liability, they are not liable to pay the instrument.

(c) If a notice of dishonor is required by Section 3-503 and is not given to the Indorser, their liability is discharged.

(d) If a draft is accepted by a bank after an endorsement is made, the Indorser's liability is discharged.

(e) If an Indorser of a check is liable under subsection (a) and the check is not presented for payment or given to a depositary bank for collection within 30 days after the indorsement, the Indorser's liability is discharged.

Imagine a friend who has borrowed money from another friend and then turns to you for help with repayment. By signing on to assist, you become an "indorser" of sorts. Now, if your friend defaults, you would be obligated to repay the debt, unless you specifically stated that you are helping "without recourse" or if your agreement is not honored within a certain timeframe (30 days in this case). If the debt is settled by another party (a bank, for example), your obligation would also be discharged.
...
(a) A person who transfers
	an instrument for consideration warrants
	to the transferee and, if the transfer is by indorsement,
	to any subsequent transferee that:
(1) the warrantor is a person
		entitled to enforce the instrument;
(2) all signatures on the instrument are
	authentic and authorized;
(3) the instrument has not been
	altered;
(4) the instrument is not subject
	to a defense or claim in recoupment of any party which
	can be asserted against the warrantor; and
(5) the warrantor has no knowledge of any insolvency proceeding
	commenced with respect to the maker or acceptor or,
...
(b) A person to whom the warranties
	under subsection (a) are made and who took the instrument in good
...
(c) The warranties stated
	in subsection (a) cannot be disclaimed with respect to checks. Unless
...
### commentary on ## § 3-416. TRANSFER	WARRANTIES.


This section outlines the warranties or guarantees made by a person who transfers a negotiable instrument, such as a check or promissory note, for consideration. The warrantor is assuring the transferee and subsequent transferees in case of endorsement, that they are a legitimate holder of the instrument, all signatures are genuine and authorized, the instrument hasn't been altered, there are no defenses or claims that can be invoked against it, and they aren't aware of any insolvency proceedings related to the maker or acceptor of the instrument. In the case of remotely-created consumer items, the warrantor also assures that the person whose account the item is drawn from gave requisite authorization.

The transferee, if they took the instrument in good faith, can recover damages from the warrantor, if any of these warranties are breached. The damages awarded are equivalent to the loss suffered due to the breach, but can't exceed the value of the instrument, plus expenses and loss of interest due to the breach.

These warranties can't be disclaimed for checks. If a claim for breach of warranty isn't reported to the warrantor within 30 days of the claimant knowing about the breach and the warrantor, the warrantor's liability is relieved to the extent of the loss caused by the delay in reporting. 

A cause of action for breach of warranty under this section occurs when the claimant becomes aware of the breach. The previous section, 3-415, discusses the obligations of an endorser while the next one, 3-417, deals with presentment warranties.
...
(a) If an unaccepted draft is
	...
	at the time of presentment, and (ii) a previous transferor
...
(1) the warrantor is, or was, at the time the warrantor
	transferred the draft, a person
...
(b) A drawee making
	...
	to receive from the drawer because of the payment. In
	...
	under this subsection is not affected by any failure of the drawee to exercise ordinary
...
(d) If (i) a dishonored draft is
	presented for payment to the drawer or an indorser or
	(ii) any other instrument is presented for payment
	to a party obliged to pay the instrument, and (iii) payment
	is received, the following rules apply:
(1) The person obtaining payment and a prior transferor
	of the instrument warrant to the person making payment
	in good faith that the warrantor is, or was, at the
	time the warrantor transferred the instrument, a person
	entitled to enforce the instrument or authorized
	to obtain payment on behalf of a person entitled
...
(e) The warranties stated
	in subsections (a) and (d) cannot be disclaimed with respect to checks. Unless
	notice of a claim for breach of warranty is given to the warrantor within 30
	days after the claimant has reason to know of the breach and the identity of
...
### commentary on ## § 3-417. PRESENTMENT	WARRANTIES.


This section outlines warranties that apply when an unaccepted draft is presented for payment or acceptance. 

Under subsection (a), the person obtaining payment or acceptance and any previous transferor of the draft guarantee to the drawee that: (i) they are entitled to enforce the draft or authorized to do so on behalf of someone else; (ii) the draft has not been altered; (iii) they have no knowledge of an unauthorized signature; (iv) the amount drawn on a remotely-created consumer item is authorized.

Under subsection (b), if these warranties are breached, the drawee can recover damages from any warrantor. This includes the amount paid, less any amount the drawee received or is entitled to receive from the drawer, and also compensation for expenses and loss of interest.

Subsection (c) outlines the defenses available to a warrantor against a claim for breach of warranty.

Subsection (d) provides similar warranties for when a dishonored draft or any other instrument is presented for payment.

Under subsection (e), these warranties can't be disclaimed for checks. If notice of a claim for breach of warranty isn't given within 30 days, the warrantor's liability is discharged to the extent of any loss caused by the delay.

Finally, subsection (f) establishes that a cause of action for breach of warranty accrues when the claimant has reason to know of the breach. 

In essence, these regulations serve to safeguard the interests of the parties involved in the transaction of a draft, ensuring its authenticity, validity, and correct execution.
...
(a) Except as provided in
	subsection (c), if the drawee of a draft pays
	or accepts the draft and the drawee acted on the mistaken belief that (i) payment
	of the draft had not been stopped pursuant to Section 4-403 or
	(ii) the signature of the drawer of the draft was authorized,
	the drawee may recover the amount of the draft from the person to whom or for
	whose benefit payment was made or, in the case of acceptance,
...
(b) Except as provided in
	subsection (c), if an instrument has been paid or
	...
	benefit payment was made or (ii) in the case of acceptance,
	may revoke the acceptance.
(c) The remedies provided
	by subsection (a) or (b) may not be asserted against a person who took the instrument in good
	faith and for value or who in good faith changed position in reliance on
	the payment or acceptance. This subsection does
	not limit remedies provided by Section 3-417 or 4-407.
(d) Notwithstanding Section 4-215,
	if an instrument is paid or accepted by mistake and
	the payor or acceptor recovers payment or revokes acceptance under
	...
	has rights as a person entitled to enforce the
...
### commentary on ## § 3-418. PAYMENT	OR ACCEPTANCE BY MISTAKE.


This section of the law details what happens when a draft is paid or accepted due to mistaken belief or error. This can be when a drawee, the person or entity on whom a draft (like a check) is drawn, makes payment believing that a stop payment order hasn't been issued, or that the drawer's (person who wrote the draft) signature is legitimate, when it's not.

In such cases, the drawee can reclaim the paid amount from the person who received the payment or benefitted from it, or revoke acceptance of the draft. The law, however, protects those who received the payment in good faith and for value.

This section also asserts that if payment or acceptance is revoked due to a mistake, the instrument (like a check or promissory note) is considered as dishonored (not paid or accepted) and the person from whom the payment is recovered has the rights to enforce the dishonored instrument.

In simple terms, if you mistakenly pay or accept money through a check or similar instrument, you're allowed to take it back or cancel your acceptance. However, if someone innocently benefits from this mistake, you can't hold them responsible. Additionally, if you do take back a mistaken payment, it's as if the check was never paid or accepted, and the person you got the money back from can then try to collect on the bounced check.
...
(a) If an instrument is issued for
	value given for the benefit of a party to the instrument
	("accommodated
...
(d) If the signature of a party to
	...
	to enforce the instrument only if (i) execution of judgment against the
...
### commentary on ## § 3-419. INSTRUMENTS	SIGNED FOR ACCOMMODATION.


This section of the Uniform Commercial Code (UCC) discusses the responsibilities and rights of accommodation parties who sign financial instruments, such as checks or promissory notes, to help another party (the accommodated party) obtain credit or funds. 

Section (a) defines an accommodation party as someone who signs a financial instrument without being a direct beneficiary of the value given for the instrument, essentially acting as a guarantor for the accommodated party. 

Section (b) provides that regardless of their role (maker, drawer, acceptor, or indorser), an accommodation party is obligated to pay the instrument and this obligation can be enforced even without any formal agreement or direct benefit to them. 

Section (c) adds that an individual signing an instrument is presumed to be an accommodation party if the signature is anomalous or accompanied by words indicating that the signer is acting as a guarantor. 

Section (d) specifies that if a party unambiguously indicates they are guaranteeing collection rather than payment, their obligation to pay only arises if the primary obligor defaults for reasons such as insolvency or inability to be served with process. 

Section (e) explains that if a party does not clearly express an intention to guarantee just collection, they are assumed to be guaranteeing payment and thus are obliged to pay in the same circumstances as the accommodated party.

Finally, Section (f) stipulates that an accommodation party who pays the instrument is entitled to reimbursement from the accommodated party and can enforce the instrument against them. However, an accommodated party that pays the instrument cannot seek contribution from the accommodation party. 

In simpler terms, this law outlines the rules for situations where someone co-signs a check or other financial document to help another person. Depending on the specifics, the co-signer might be responsible for paying the debt if the original party can't or won't, and they can also seek reimbursement from that party.
...
(b) In an action under subsection
	(a), the measure of liability is presumed to be the amount payable on the instrument,
	but recovery may not exceed the amount of the plaintiff's interest in the instrument.
(c) A representative, other
	than a depositary bank, who has in good faith dealt
	with an instrument or its proceeds on behalf of one
...
### commentary on ## § 3-420. CONVERSION	OF INSTRUMENT.


This law states that the regulation of personal property conversion applies to instruments (legal documents like checks or promissory notes). Conversion here refers to the act of wrongfully possessing or using property belonging to another party without their permission. This law also expands the definition of conversion to include situations where an instrument is transferred from a person who doesn't have the right to enforce the instrument, or when a bank makes or acquires payment for a person who isn't entitled to enforce the instrument or receive payment.

The law also stipulates that the issuer or acceptor of the instrument or a payee or indorsee who didn't receive the delivery of the instrument either directly or via an agent or co-payee cannot bring an action for conversion of the instrument.

The measure of liability in a conversion action is presumed to be the amount payable on the instrument, but the recovery cannot exceed the amount of the plaintiff's interest in the instrument. 

Lastly, a representative who has in good faith dealt with an instrument or its proceeds on behalf of someone who was not the person entitled to enforce the instrument, is not liable in conversion to that person beyond the amount of any proceeds that it has not paid out, as long as they are not a depositary bank.
...
(a) "Presentment" means
	...
	entitled to enforce an instrument (i) to pay the
	instrument made to the drawee or a party obliged
	to pay the instrument or, in the case of a note or accepted draft payable
	at a bank, to the bank, or (ii) to accept a draft made to the drawee.
(b) The following rules are
	subject to Article 4, agreement of the parties, and clearing-house rules and
	the like:
(1) Presentment may be made at the place of payment
	of the instrument and must be made at the place of
	payment if the instrument is payable at a bank in the United States; may be
	...
	received by the person to whom presentment is made;
...
(2) Upon demand of the person to whom presentment is
	...
	another person, reasonable evidence of authority to do so, and (iii) sign a
	receipt on the instrument for any payment made or surrender the instrument if
...
(3) Without dishonoring the instrument,
	...
	the presentment to comply with the terms of the instrument, an agreement of
	the parties, or other applicable law or rule.
(4) The party to whom presentment is
	made may treat presentment as occurring on the next business day after the day
	of presentment if the party to whom presentment is made has established a cut-off
	hour not earlier than 2 p.m. for the receipt and processing of instruments presented
...
### commentary on ## § 3-501. PRESENTMENT.


"Presentment" in this section refers to the act of demanding payment or acceptance of an instrument by or on behalf of the person entitled to enforce the instrument. Presentment can be made by any commercially reasonable means, including oral, written or electronic communication. Moreover, it is effective when the demand is received by the person to whom it is made.

The rules laid out in this section govern presentment, and can be superseded by Article 4, agreements between parties, and rules of clearing houses. The rules specify that presentment should be made at the place of payment, especially if the instrument is payable at a bank in the United States.

If demanded, the person making the presentment must exhibit the instrument, provide reasonable identification and proof of authority to act on behalf of another person, and sign a receipt or surrender the instrument if full payment is made.

The party to whom the presentment is made can refuse the instrument if it lacks a necessary endorsement, or if the presentment does not comply with the terms of the instrument, an agreement of the parties, or other applicable law or rule. The party also has the right to treat the presentment as occurring on the next business day if the presentment was made after a set cut-off hour, which cannot be earlier than 2 p.m.

To put it simply, this section lays out the rules and protocols for demanding payment or acceptance of financial instruments, with specific considerations for the location, timing and conditions of the demand.
...
(1) If the note is payable on
	demand, the note is dishonored if presentment is
	duly made to the maker and the note is not paid on the
	day of presentment.
(2) If the note is not payable
	on demand and is payable at or through a bank or the terms of the note require presentment,
	the note is dishonored if presentment is duly made and the note is not paid
	on the day it becomes payable or the day of presentment, whichever is later.
(3) If the note is not payable
	on demand and paragraph (2) does not apply, the note is dishonored if it is
...
(1) If a check is duly presented
	for payment to the payor bank otherwise than for immediate payment over the
	counter, the check is dishonored if the payor bank makes timely return of the
	check or sends timely notice of dishonor or nonpayment under Section 4-301 or 4-302,
	or becomes accountable for the amount of the check under
	Section 4-302.
(2) If a draft is payable on
	demand and paragraph (1) does not apply, the draft is dishonored if presentment for
	payment is duly made to the drawee and the draft is not
	paid on the day of presentment.
(3) If a draft is payable on
	a date stated in the draft, the draft is dishonored if (i) presentment for
	payment is duly made to the drawee and payment is not
	made on the day the draft becomes payable or the day of presentment, whichever
	is later, or (ii) presentment for acceptance is duly
	made before the day the draft becomes payable and the draft is not accepted
	on the day of presentment.
(4) If a draft is payable on
	elapse of a period of time after sight or acceptance,
	the draft is dishonored if presentment for acceptance
	is duly made and the draft is not accepted on the day of presentment.
(c) Dishonor of an unaccepted
	documentary draft occurs according to the rules stated
	in subsection (b)(2), (3), and (4), except that payment or acceptance may
	be delayed without dishonor until no later than the close of the third business
	day of the drawee following the day on which payment or
	acceptance is required by those paragraphs.
(d) Dishonor of an accepted draft is
	governed by the following rules:
(1) If the draft is payable
	on demand, the draft is dishonored if presentment for
	payment is duly made to the acceptor and the draft is
	not paid on the day of presentment.
(2) If the draft is not payable
	on demand, the draft is dishonored if presentment for
	payment is duly made to the acceptor and payment is
	not made on the day it becomes payable or the day of presentment, whichever
	is later.
...
(f) If a draft is
	dishonored because timely acceptance of the draft
	was not made and the person entitled to demand acceptance consents to a late
	acceptance, from the time of acceptance the draft is treated as never having
	been dishonored.
...
### commentary on ## § 3-502. DISHONOR.


This section of the Uniform Commercial Code sets out the rules for when a note or draft (types of financial instruments) is considered to be dishonored. 

For notes:
- If the note is payable on demand, it is dishonored if it is presented to the maker and is not paid on the day of presentment.
- If the note is not payable on demand but requires presentment, it is dishonored if it is not paid on the day it becomes payable or the day of presentment, whichever is later.
- If the note is not payable on demand and presentment is not required, it is dishonored if it is not paid on the day it becomes payable.

For draft:
- If a check is presented for payment to the payor bank and is not paid, it is dishonored.
- If a draft is payable on demand and is not paid on the day of presentment, it is dishonored.
- If a draft is payable on a specific date and is not paid on that date or the date of presentment, it is dishonored.
- If a draft is payable after a period of time and is not accepted on the day of presentment, it is dishonored.

The section also outlines rules for when dishonor occurs when presentment is excused, and when a draft is treated as not having been dishonored if late acceptance is consented to. 

In simple terms, this section is like the "rules of the road" for financial transactions using notes and drafts. It sets out when a note or draft is considered to be "in default" or "bounced".
...
(a) The obligation of an indorser stated
	in Section 3-415(a) and the obligation of a drawer stated
	in Section 3-414(d) may not be enforced unless (i) the
	indorser or drawer is given notice of dishonor of the instrument complying
	with this section or (ii) notice of dishonor is excused under Section 3-504(b).
(b) Notice of dishonor may
	be given by any person; may be given by any commercially reasonable means, including
	an oral, written, or electronic communication; and is sufficient if it reasonably
	identifies the instrument and indicates that the instrument
...
(c) Subject to Section 3-504(c),
	with respect to an instrument taken for collection
	by a collecting bank, notice of dishonor must be given (i) by the bank before
	midnight of the next banking day following the banking day on which the bank
	receives notice of dishonor of the instrument, or (ii) by any other person within
	30 days following the day on which the person receives notice of dishonor. With
	respect to any other instrument, notice of dishonor must be given within 30
...
### commentary on ## § 3-503. NOTICE	OF DISHONOR.


§ 3-503 of the Uniform Commercial Code relates to the notice of dishonor, which is a crucial part of the process when a financial instrument, such as a check or a promissory note, is not paid or accepted. 

In layman's terms:

(a) The people who endorsed (signed on the back of the check to endorse it to someone else) or wrote the check can't be held responsible unless they are given a notice that the check was not honored by the bank (because of insufficient funds for example), or unless this notice is excused under some specific circumstances.

(b) Anyone can give this notice of dishonor, it can be given in any way that makes sense in the business world - in person, in writing or electronically. It just needs to be clear enough about which check it relates to and that the check was not honored. If a bank returns a check that was given to it for collection, that's good enough as a notice of dishonor.

(c) If a collecting bank is dealing with a check, they need to give notice of dishonor by the end of the next banking day after they receive the notice themselves. If it's not a bank, but someone else, they have 30 days to give this notice. For any other type of financial instrument, the notice needs to be given within 30 days of the instrument not being honored. 

In short, if a check or similar financial instrument isn't accepted or paid, the person responsible needs to be notified, and there are rules about how and when this notification has to happen.
...
(a) Presentment for payment
	...
	excused if (i) the person entitled to present the instrument cannot with reasonable
	diligence make presentment, (ii) the maker or acceptor has
	repudiated an obligation to pay the instrument or is dead or in insolvency proceedings,
	(iii) by the terms of the instrument presentment is
	not necessary to enforce the obligation of indorsers or
	the drawer, (iv) the drawer or indorser whose obligation
	is being enforced has waived presentment or otherwise
	has no reason to expect or right to require that the instrument be paid or accepted,
	or (v) the drawer instructed the drawee not to pay or
	accept the draft or the drawee was not obligated to the
	drawer to pay the draft.
(b) Notice of dishonor is
	excused if (i) by the terms of the instrument notice
	of dishonor is not necessary to enforce the obligation of a party to
...
(c) Delay in giving notice
	of dishonor is excused if the delay was caused by circumstances beyond the control
	of the person giving the notice and the person giving the notice exercised reasonable
...
### commentary on ## § 3-504. EXCUSED	PRESENTMENT AND NOTICE OF DISHONOR.


This section of the law explains when presentment for payment or acceptance of an instrument is excused, i.e., not required. Some examples include when the person entitled to present the instrument can't do so with reasonable diligence, the maker has repudiated their obligation to pay, the drawer or indorser has waived presentment, or the drawer instructed the drawee not to pay the draft.

It also covers when notice of dishonor (i.e., a notice that payment or acceptance has not been made) is excused. This can happen if the terms of the instrument state that notice of dishonor isn't necessary, or if the party whose obligation is being enforced waived notice of dishonor. Importantly, waiving presentment also means waiving notice of dishonor.

Finally, this section of the law excuses delays in giving notice of dishonor if they were caused by circumstances beyond the person's control and if that person acted with reasonable diligence after the cause of the delay ended. 

In simpler terms, this section is like a 'get out of jail free' card for those who are unable to meet the standard requirements of presentment or notice under certain circumstances. The law understands that life happens, and there may be legitimate reasons for delays or non-compliance. As long as you can show you were acting reasonably and diligently, you should be excused.
...
(3) a book or record of the drawee,
	payor bank, or collecting bank, kept in the usual course of business which shows
	dishonor, even if there is no evidence of who made the entry.
(b) A protest is a certificate
	of dishonor made by a United States consul or vice consul, or a notary public
	or other person authorized to administer oaths by the law of the place where
	dishonor occurs. It may be made upon information satisfactory to that
	person. The protest must identify the instrument and
	certify either that presentment has been made or,
	if not made, the reason why it was not made, and that the instrument has been
...
### commentary on ## § 3-505. EVIDENCE	OF DISHONOR.


This section of the law deals with what can be considered as evidence for dishonor (non-payment or non-acceptance) of a financial instrument like a check or bill of exchange. Three types of evidence are identified and they are presumed to show dishonor and any notice of dishonor:

1. A document, known as a protest, which is regular in form and purports to be a formal declaration that the instrument has been dishonored.
2. A stamp or writing from the drawee, payor bank, or presenting bank stating that acceptance or payment has been refused, unless there are reasons stated for the refusal which are inconsistent with dishonor.
3. Record kept in the usual course of business by the drawee, payor bank, or collecting bank, which shows dishonor, even if there is no evidence of who made the entry.

The section goes on to describe what a protest is. It is a certificate of dishonor made by a U.S. consul or vice consul, a notary public, or another person authorized to carry out official duties under local law. The protest must identify the instrument, confirm that it has been presented or give a reason for not doing so, and certify that it has been dishonored through non-acceptance or non-payment. The protest can also confirm that notice of dishonor has been given to some or all parties involved. 

In simple terms, this section provides guidance on what constitutes evidence of non-payment or refusal to accept a financial instrument and outlines the formal process of making and recording such an event.
...
(a) The obligation of a party to
	pay the instrument is discharged as stated in this
	Article or by an act or agreement with the party which
	would discharge an obligation to pay money under a simple contract.
(b) Discharge of the obligation
	of a party is not effective against a person acquiring
	rights of a holder in due course of the instrument without
...
### commentary on ## § 3-601. DISCHARGE	AND EFFECT OF DISCHARGE.


This section of the Uniform Commercial Code (UCC) discusses how the obligation of a party to pay a financial instrument can be discharged. 

(a) A party's obligation to pay can be discharged, or eliminated, in two ways. The first way is as specified in the UCC, which might include circumstances like payment in full, or the expiration of the instrument. The second way is through an act or agreement, similar to how a simple contract could be discharged. This could happen, for example, if the parties agree to cancel the instrument or if the party obligated to pay has declared bankruptcy.

(b) However, the discharge of a financial obligation doesn't necessarily affect others who weren't involved in the original agreement. For instance, even if the original parties agree to discharge the obligation, a person who later acquires the instrument as a holder in due course (someone who receives the instrument in good faith and without knowledge of any issues) may still be entitled to enforce the obligation. This means that the person who was originally supposed to pay can still be legally required to pay the holder in due course, despite the discharge. 

In simpler terms, if you write a check and it's cashed, you can't just agree with the person you wrote the check to that you don't have to pay it anymore. If that person already deposited the check, your bank is still going to take the money out of your account. And if the person you wrote the check to sold it to someone else before it was cashed, that person can still enforce the check against you.
...
(a) Subject to subsection
	(b),	an instrument is paid to the extent payment is
	made	(i) by or on behalf of a party obliged to pay the
	instrument,	and (ii) to a person entitled
	to enforce the instrument. To the extent of the payment, the obligation
	...
	another person.
(b) Subject to subsection (e) a note
	is paid to the extent payment is made by or on behalf of a party obliged
	to pay the note to a person that formerly was entitled to enforce the note only
	if at the time of the payment the party obliged to pay has not received adequate
	notification that the note has been transferred and that payment is to be made
	to the transferee. A notification is adequate only if it is signed by the transferor
	or the transferee; reasonably identifies the transferred note; and provides
	an address at which payments subsequently can be made. Upon request, a transferee
	shall seasonably furnish reasonable proof that the note has been transferred.
	Unless the transferee complies with the request, a payment to the person that
	formerly was entitled to enforce the note is effective for purposes of subsection
	(c) even if the party obliged to pay the note has received a notification under
	this paragraph. 
(c) Subject to subsection (e), to
	the extent of a payment under subsections (a) and (b), the obligation of the party obliged
	to pay the instrument is discharged even though payment is made with knowledge
	of a claim to the instrument under Section 3-306 by another
	person. 
(d) Subject to subsection (e), a
	transferee,	or any party that has acquired rights in the
	instrument directly or indirectly from a transferee, including any such party
	that has rights as a holder in due course, is deemed to have notice of any payment
	that is made under subsection (b) after the date that the note is transferred
	to the transferee but before the party obliged to pay the note receives adequate
	notification of the transfer. 
(e) The obligation of a party to
	pay the instrument is not discharged under subsections
	(a) through (d) if:
(1) a claim to the instrument under
	Section 3-306 is enforceable against the party receiving
	payment and (i) payment is made with knowledge by the payor that payment is
	prohibited by injunction or similar process of a court of competent jurisdiction,
	or (ii) in the case of an instrument other than a cashier's
	check, teller's check, or certified
	check, the party making payment accepted, from the person having a claim
	to the instrument, indemnity against loss resulting from refusal to pay the person
	entitled to enforce the instrument; or
(2) the person making payment knows that the instrument is
	a stolen instrument and pays a person it knows is in wrongful possession of
	the instrument.
(f) As used in this section, "signed," with
	respect to a record that is not a writing, includes the attachment to or logical
	association with the record of an electronic symbol, sound, or process to or
	with the record with the present intent to adopt or accept the record. 
...
### commentary on ## § 3-602. PAYMENT.


This section provides guidelines on the payment of an instrument, which is any written legal document that records and gives a right to a monetary transaction. 

Subsection (a) states that an instrument is paid when payment is made by or on behalf of the party obligated to pay the instrument to the person entitled to enforce the instrument. The obligation of the party to pay is discharged once payment is made, even if they are aware of another party's claim to the instrument.

Subsection (b) provides that a note (a promise to pay a certain amount of money) is considered paid when payment is made by or on behalf of the party obliged to pay the note to a person who was formerly entitled to enforce the note. However, this is only true if the party obligated to pay has not received adequate notification that the note has been transferred and that payment should be made to the transferee.

Subsection (c) reiterates that the obligation of the party to pay is discharged once payment is made, even if they are aware of another party's claim to the instrument.

Subsection (d) stipulates that a transferee or any party that has acquired rights in the instrument from a transferee is deemed to have notice of any payment made under subsection (b) after the note has been transferred to the transferee but before the party obliged to pay the note receives adequate notification of the transfer. 

Subsection (e) states that the obligation of a party to pay the instrument is not discharged if a claim to the instrument is enforceable against the party receiving payment and the payment is made despite knowledge of a court order prohibiting such payment, or if the person making payment knows that the instrument is stolen and pays a person they know is in wrongful possession of the instrument.

Subsection (f) defines "signed" in the context of an electronic record as the attachment or association of an electronic symbol, sound, or process to the record with the intention to adopt or accept the record.
...
(c) If tender of payment of
	an amount due on an instrument is made to a person
	entitled to enforce the instrument, the obligation of the obligor to pay
	interest after the due date on the amount tendered is discharged. If presentment is
	required with respect to an instrument and the obligor is able and ready to
	pay on the due date at every place of payment stated in the instrument, the
	obligor is deemed to have made tender of payment on the due date to the person
	entitled to enforce the instrument.
...
### commentary on ## § 3-603. TENDER	OF PAYMENT.


Section 3-603 discusses the implications of tendering payment for an obligation under an instrument (like a cheque or note). 

Subsection (a) states that if a payment offer is made to a person who has the right to enforce the instrument, the laws governing the tender of payment in a simple contract are applied. This implies that a lawful offer of payment is regarded as satisfying the obligation, unless there’s some contractual agreement stating otherwise. 

Subsection (b) says that if a tender of payment for an obligation is refused by the person entitled to enforce the instrument, the responsibility of an indorser or accommodation party, who has a right of recourse, is discharged to the extent of the amount tendered. This means that if the person entitled to enforce the payment refuses the tender, it relieves the third party (like a guarantor or co-signer) of their obligation to the extent of the amount offered.

Subsection (c) clarifies that if a payment offer is made for an amount due on an instrument to a person entitled to enforce it, the person offering the payment is no longer obligated to pay interest on the amount after the due date. If presentment is required (i.e., formally demanding payment), and the person obligated to pay is ready and able to do so on the due date at every place of payment mentioned in the instrument, they are considered to have made a tender of payment on the due date to the person entitled to enforce the instrument. 

In simpler terms, if you offer to pay what you owe on time and in the right manner, you shouldn’t need to pay extra interest. If the person who should be accepting your payment refuses, it may also relieve others who might have had to pay on your behalf.
...
(a) A person
		entitled to enforce an instrument, with or without consideration,
		may discharge the obligation of	a party to pay the instrument
		(i) by an intentional voluntary act, such as surrender of the instrument to
		the party, destruction, mutilation, or cancellation of the instrument, cancellation
		or striking out of the party's signature, or the addition of words to the instrument
...
(b) Cancellation or striking
	out of an indorsement pursuant to subsection (a)
	does not affect the status and rights of a party derived
	from the indorsement.
(c) As used in this section, "signed," with
	respect to a record that is not a writing, includes the attachment to or logical
	association with the record of an electronic symbol, sound, or process to or
	with the record with the present intent to adopt or accept the record.
...
### commentary on ## § 3-604. DISCHARGE	BY CANCELLATION OR RENUNCIATION.


The section describes how the obligation to pay an instrument can be discharged by the person who is entitled to enforce it. The discharge can occur through a voluntary act like surrendering, destroying, or cancelling the instrument, or by the person agreeing not to sue or renouncing their rights against the party. However, cancelling an endorsement does not affect the status and rights of a party that come from the endorsement. The section also defines what "signed" means in relation to a record that is not a writing.

In simpler terms, this law outlines how a person, who has the right to enforce payment on a check or promissory note, can freely choose to let the debtor off the hook. They can do this by either physically altering the instrument or by formally agreeing not to sue the debtor. Interestingly, if an endorsement (a signature on the back of a check, for example) is cancelled, the rights of the party that came from that endorsement stay intact. The law also clarifies that signing can also mean attaching an electronic symbol, sound, or process to a record. 

In terms of timeline, this law is likely an evolution of how contracts and obligations have been managed and discharged. In the past, physical actions such as destroying or surrendering the instrument were common, but in the digital age, electronic symbols or processes can also serve as signatures. 

A possible counterpart in common law might be the concept of "accord and satisfaction," where a dispute is settled by the parties agreeing to accept less than what's owed, effectively discharging the obligation.
...
### commentary on ## § 3-605. DISCHARGE	OF SECONDARY OBLIGORS.


This section of the Uniform Commercial Code (UCC) addresses how secondary obligors, or co-signers, are affected when the principal obligor, or main signer, of a financial instrument is released from their obligations in part or in entirety. It also outlines how extensions, modifications, or impairments of collateral to the principal’s obligation affect the secondary obligor. 

In summary, it explains that:

- If the principal obligor is released from their obligation, the secondary obligor is also discharged to the same extent, unless the terms of the release state otherwise.

- If the principal obligor is granted an extension, the secondary obligor's obligations are also extended, unless it would cause them a loss. 

- If the obligation is modified, the secondary obligor's obligations are also modified, unless it would cause them a loss. 

- If the value of collateral is impaired, the secondary obligor is released to the extent of the impairment. 

- The secondary obligor is not released unless the person enforcing the instrument knows that they are a secondary obligor or has been notified that the instrument was signed for accommodation.

- A secondary obligor is not released if they consent to the event or conduct causing the release, or if they waive their discharge rights. 

- A secondary obligor retains the right of recourse if the release or extension terms provide for it. 

- The secondary obligor has the burden of proving the occurrence of harmful acts and the loss caused by them.

- If the secondary obligor shows prejudice caused by an impairment of recourse and the loss is not calculable, it is assumed that the impairment caused a loss equal to their liability on the instrument, unless proven otherwise.
...
### commentary on ## PART 1. GENERAL PROVISIONS AND DEFINITIONS


This part of the Uniform Commercial Code, specifically titled Article 3, is more commonly known as the "Negotiable Instruments" statute. This section sets out the framework for the usage, enforceability, and understanding of negotiable instruments such as checks, promissory notes, and drafts. It provides detailed and specific definitions for terms used throughout the article, establishes the criteria for an instrument to be considered negotiable, outlines the obligations of each party involved, and sets the statute of limitations for any actions related to these instruments. Any confusion or disputes regarding negotiable instruments are often referred to this section for clarification and resolution.
...
### commentary on ## PART 2. NEGOTIATION, TRANSFER, AND	INDORSEMENT


Negotiation, in terms of a negotiable instrument such as a check or promissory note, refers to the transfer of the instrument from one party to another in such a way that the transferee becomes the holder. If an instrument is payable to bearer, it is negotiated by delivery; if it is payable to order, it is negotiated by the owner's signature and delivery.

§ 3-202. NEGOTIATION	SUBJECT TO RESCISSION
This section indicates that negotiation is effectively reversible or voidable. In other words, if a negotiable instrument was transferred under fraudulent or illegal circumstances, the negotiation can be rescinded.

§ 3-203. TRANSFER	OF INSTRUMENT; RIGHTS ACQUIRED BY TRANSFER
This section discusses how a transferee acquires the rights to a negotiable instrument. When a negotiable instrument is transferred, the transferee obtains the same rights as the transferor. 

§ 3-204. INDORSEMENT
Endorsement refers to the act of a payee or holder signing a negotiable instrument, such as a check, to transfer ownership to another party. This section provides details on how an endorsement should occur.

§ 3-205. SPECIAL	INDORSEMENT; BLANK INDORSEMENT; ANOMALOUS INDORSEMENT
Here, three types of endorsement are discussed. A special endorsement specifies the person to whom the instrument is to be payable. A blank endorsement does not specify a payee, making the instrument payable to the bearer. An anomalous endorsement is one made by a person who is not the holder of the instrument.

§ 3-206. RESTRICTIVE	INDORSEMENT
This section refers to an endorsement that includes certain restrictions regarding the use of the instrument.

§ 3-207. REACQUISITION
Reacquisition refers to a situation where a party that had previously disposed of a negotiable instrument acquires it again. This section addresses how a negotiable instrument can be reacquired and the rights of the parties involved in such transactions.
...
### commentary on ## PART 3. ENFORCEMENT OF INSTRUMENTS


&sect; 3-312. LOST, DESTROYED, OR STOLEN CASHIER'S CHECK, TELLER'S CHECK, OR CERTIFIED CHECK. 
This section addresses what happens when a cashier's check, teller's check, or certified check is lost, destroyed, or stolen. It outlines the process for declaring the item lost and the steps that must be taken to enforce the instrument or receive compensation. 

§ 3-306. CLAIMS TO AN INSTRUMENT. 
This section deals with the rights of someone who claims to have a legitimate claim to an instrument, such as a check or note, but who is not in possession of it. It outlines the scenarios in which someone else may have possession of the instrument, such as if it was stolen or lost, and the obligations of the person who currently possesses it. 

§ 3-307. NOTICE OF BREACH OF FIDUCIARY DUTY. 
This provision addresses the process when there has been a breach of fiduciary duty in relation to an instrument. It covers who needs to be notified, when, and what steps need to be taken following the notice. 

§ 3-308. PROOF OF SIGNATURES AND STATUS AS HOLDER IN DUE COURSE.
This section provides guidance on how to prove the authenticity of signatures on an instrument and to confirm someone's status as a holder in due course. It could be crucial to determine the legality of transactions and the rights of various parties involved.

§ 3-309. ENFORCEMENT OF LOST, DESTROYED, OR STOLEN INSTRUMENT. 
This section outlines the rights and procedures for someone who owns an instrument that has been lost, destroyed, or stolen. It addresses how to enforce the instrument and the evidence required to establish ownership.

§ 3-310. EFFECT OF INSTRUMENT ON OBLIGATION FOR WHICH TAKEN. 
This section outlines how an instrument (like a promissory note) affects the underlying obligation for which it was given. It details the scenarios under which the obligation is suspended or discharged.

§ 3-311. ACCORD AND SATISFACTION BY USE OF INSTRUMENT. 
This section explains how an instrument can be used to create an accord and satisfaction, which happens when the parties agree to settle a dispute and fulfill the agreed-upon terms.

§ 3-301. PERSON ENTITLED TO ENFORCE INSTRUMENT. 
This section outlines who is legally allowed to enforce the terms of a financial instrument. This could be the original creditor, a debt collector, or another party.

§ 3-302. HOLDER IN DUE COURSE. 
This section defines what it means to be a "holder in due course" – a person who has received a negotiable instrument in good faith and without notice of any defects.

§ 3-303. VALUE AND CONSIDERATION. 
This section defines the idea of "value" and "consideration" in the context of negotiable instruments. It explains when an instrument is considered to have been issued for value and what constitutes good consideration.

§ 3-304. OVERDUE INSTRUMENT. 
This section explains how to handle an overdue instrument, such as a check or promissory note, and the rights and responsibilities of the person holding it.

§ 3-305. DEFENSES AND CLAIMS IN RECOUPMENT. 
This section outlines the defenses that can be used when someone tries to enforce an instrument, and the process for making claims in recoupment, which involves counterclaiming against the person trying to enforce the instrument.
...
### commentary on ## PART 4. LIABILITY OF PARTIES


The Articles of the Uniform Commercial Code (UCC) listed above are related to the liabilities of parties involved in a negotiable instrument transaction. They detail the responsibilities and obligations of individuals who sign, endorse, or alter these instruments and the consequences of unauthorized or fraudulent activities.

§ 3-401. SIGNATURE refers to the necessity of a signature on a negotiable instrument for it to be legally binding. The signature indicates consent or agreement to the terms of the instrument.

§ 3-402. SIGNATURE BY REPRESENTATIVE details the circumstances under which a representative can sign a negotiable instrument on behalf of another party.

§ 3-403. UNAUTHORIZED SIGNATURE addresses the ramifications of a signature that was not authorized by the party it represents.

§ 3-404. IMPOSTORS; FICTITIOUS PAYEES deals with cases where the payee is either an impostor or a fictitious person.

§ 3-405. EMPLOYER’S RESPONSIBILITY FOR FRAUDULENT INDORSEMENT BY EMPLOYEE discusses the employer's liability if an employee fraudulently endorses a check or other negotiable instrument.

§ 3-406. NEGLIGENCE CONTRIBUTING TO FORGED SIGNATURE OR ALTERATION OF INSTRUMENT addresses scenarios where a party's negligence contributes to their instrument being forged or altered.

§ 3-407. ALTERATION discusses the legal implications of altering a negotiable instrument.

§ 3-408. DRAWEE NOT LIABLE ON UNACCEPTED DRAFT absolves the drawee (the party ordered to pay) of responsibility if they have not accepted the draft.

§ 3-409 - § 3-415 discuss various scenarios related to the acceptance of drafts, issuance of notes or cashier’s check, and the obligations of the drawer and endorser.

§ 3-416. TRANSFER WARRANTIES and § 3-417. PRESENTMENT WARRANTIES outline the promises made by the transferor and presenter of an instrument respectively.

§ 3-418. PAYMENT OR ACCEPTANCE BY MISTAKE covers situations where a payment or acceptance of a negotiable instrument is made by mistake.

§ 3-419. INSTRUMENTS SIGNED FOR ACCOMMODATION discusses the liabilities and rights of parties who sign a negotiable instrument for the purpose of lending their credit to another party.

§ 3-420. CONVERSION OF INSTRUMENT relates to the illegal conversion of a negotiable instrument.
...
### commentary on ## PART 5. DISHONOR


§ 3-501. PRESENTMENT: This section refers to the legal process by which a negotiable instrument (such as a check or bill of exchange) is presented for payment to the party that is obligated to pay it. 

§ 3-502. DISHONOR: Dishonor refers to the refusal of the obligated party to pay the instrument when it is presented. This could be due to insufficient funds, a stop payment instruction, or a dispute over the validity of the instrument.

§ 3-503. NOTICE OF DISHONOR: This section refers to the obligation of the person presenting the instrument to notify the drawer (the person who issued the instrument) or endorser (the person who transferred the instrument) that the instrument has been dishonored.

§ 3-504. EXCUSED PRESENTMENT AND NOTICE OF DISHONOR: In certain circumstances, presentment and notice of dishonor may be excused. This could happen, for instance, if the drawer or endorser has waived their right to presentment or notice, or if due diligence to present the instrument or give notice has been exercised but was unsuccessful.

§ 3-505. EVIDENCE OF DISHONOR: Evidence of dishonor could include a written statement from the bank refusing payment, a returned check marked "insufficient funds," or a witness who can testify to the refusal of the obligated party to pay. This evidence can be used in legal proceedings to establish that the instrument was dishonored.
...
### commentary on ## PART 6. DISCHARGE AND PAYMENT


§ 3-601. DISCHARGE AND EFFECT OF DISCHARGE

This section of the Uniform Commercial Code discusses how an obligation or liability can be discharged and the effects of such discharge. It outlines the scenarios under which an individual or entity would no longer be obligated to fulfill a previously agreed-upon responsibility. This could occur through the fulfillment of the obligation, the agreement of both parties to discharge the obligation, or through other legal measures. The effect of such discharge would be the absolution of any further liability or obligation. 

§ 3-602. PAYMENT

This section details the rules and regulations around payment. This includes how payment should be made, who should make the payment, and when the payment should be made. It also discusses the effects of full or partial payment on the obligation or liability.

§ 3-603. TENDER OF PAYMENT

This section refers to when a debtor offers to pay a creditor the amount they owe. It explains what constitutes a legal tender of payment and how a refusal of such a tender by the creditor can impact the debtor's liability for interest and costs.

§ 3-604. DISCHARGE BY CANCELLATION OR RENUNCIATION

This section deals with how an obligation or liability can be discharged through cancellation or renunciation. It outlines the protocols for such discharge, including the agreement of the parties involved and the timeframe within which this should occur.

§ 3-605. DISCHARGE OF SECONDARY OBLIGORS

This section talks about the discharge of secondary obligors. These are individuals or entities that have a secondary responsibility for the obligation or liability if the primary obligor fails to fulfill it. This section explains the circumstances under which these secondary obligors can be discharged from their obligations.
